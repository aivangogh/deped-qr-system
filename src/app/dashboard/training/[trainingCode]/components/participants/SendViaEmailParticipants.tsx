...
import { sendBulkCerficatesWithEmailsForParticipants } from '@/services/fetch/sendViaEmail';

export default function SendViaEmailParticipants() {
  ...
  const handleSendBulkCertificates = useCallback(async () => {
    ...
    await sendBulkCerficatesWithEmailsForParticipants(requestData)
      .then((res) => {
        console.log(res);
        if (res.status == 200) {
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[475px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Send certificates for all participants in the table.
            </DialogDescription>
          </DialogHeader>
